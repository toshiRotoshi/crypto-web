...
<body>
    ...
    <header>
        <div id="logo">
            <a href="index.php">
                <img src="https://public-assets.dragonfi.ph/logo/dragonfi-logo-white.svg" alt="">
            </a>
        </div>
        <ul class="nav" id="nav">
            <ul class="navLogo">
            ...
            <li class="nav-link login-btn"><a href="sign-in/sign-in.php">LOGIN</a></li>
            <li class="nav-link register-btn"><a href="sign-up/sign-up.php">REGISTER</a></li>
    ...
    <section class="hero gridSection">
        <div class="sectionDesc">
            ...
            <p class="sub-headline">
                Safest Crypto Exchage right now! Almost 1 million users all around the world.
            </p>
        </div>
    ...
    <section>
        <div class="carouselContainer">
            ...
            <div class="eachCarousel">
                ...
                <article class="carouselDesc">
                    <h1 class="carouselTitle">Google</h1>
                    <p class="carouselPara">Google tokenized stock FTX (GOOGL) is a token of Google stock network. </p>
                    <div class="carouselPrice">
                        <h3>$3,300.38</h3>
                        <span class="rect"></span>
                        <h3 class="carouselDiscount">5%</h3>
                    </div>
                    <button class="btn carouselBtn">Buy & Trade</button>
                </article>
            </div>
            ...
            <div class="eachCarousel">
                ...
                <article class="carouselDesc">
                    <h1 class="carouselTitle">Twitter</h1>
                    <p class="carouselPara">Click here to find more</p>
                    <div class="carouselPrice">
                        <h3>$44,600</h3>
                        <span class="rect"></span>
                        <h3 class="carouselDiscount">9%</h3>
            ...
            <div class="eachCarousel">
                <img src="/img/mcdo-icon.png" alt="">
                <article class="carouselDesc">
                    <h1 class="carouselTitle">McDonald's</h1>
                    <p class="carouselPara">Learn more about McDonald's Stock Information.</p>
                    <div class="carouselPrice">
                        <h3>$100,000</h3>
                        <span class="rect"></span>
                        <h3 class="carouselDiscount">4%</h3>
    ...
    <!-- Processes -->
    <section class="gridSection process-container">
        <div class="sectionDesc processessDesc">
            <h1 class="sectionHeader">Chain Process</h1>
            <p class="sectionPara">We do not charge any fees and we do not require any registration. You keep your privacy and your coins.
            </p>
    ...
    <section class="gridSection">
        <div class="sectionDesc marketDesc">
            ...
            <p class="sectionPara">The Blockchain is a decentralized, digital ledger of transactions that are recorded confirmed
            </p>
            ...
            <div class="eachMarket">
                ...
                <div>
                    ...
                    <p class="darkPara">
                        Cryptocurrency, especially Bitcoin, has proven to be a popular trading vehicle, even if legendary investors as good.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="gridSection">
        <div class="sectionDesc dashboardDesc">
            ...
            <p class="sectionPara">
                you can mine bitcoin from your own phone! You no longer have to worry about costly transactions.
            </p>
    ...
    <footer>
        ...
        <div class="footerlinksContainer">
            <div class="footerAboutus">
                ...
                <p class="darkPara">Easiest and is the most reliable way to trade for Cryptocurrency.
                </p>
